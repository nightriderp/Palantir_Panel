...
| 11.11   | SimpleAdmin-Stealth-Modul eigener Schalter, Vorgabe aus („You are hidden“)                                                     | läuft (0.0.31)   |
| 11.12   | Übungs-Einstellungen (Befehle der Map „Dust 2 Utility“), Nur CT, Aufwärmphase in 1 s                                           | läuft (0.0.32)   |
| 11.13   | Nur CT mit Teamwahl nach 1 s, Aufwärmphase 5 s ohne Chat-Meldungen                                                             | läuft (0.0.33)   |
| 11.14   | Eigenes Plugin: Aufwärmphase endet beim Beitritt, Beitritt als CT ohne Sperre                                                  | läuft (0.0.34)   |
| 11.15   | Plugin: Spawns (!spawn, !tspawn, !ctspawn, !spawns), !save/!back, CT-Beitritt per jointeam statt ChangeTeam; keine Puppen-Bots | **dieses Image** |
