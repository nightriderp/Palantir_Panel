#!/bin/sh
#
# Konsolen-Anschluss des Paper-Images.
#
...
#
# Der Befehl geht in das benannte Rohr, das `start.sh` angelegt hat und das die
# Standardeingabe des Servers ist. Er wird damit wirklich ausgeführt, nicht nur
# entgegengenommen.
#
# **Die Antwort steht im Log, nicht hier.** Ein Minecraft-Server antwortet auf
# seiner Konsole, nicht an den Absender – wer `list` schickt, sieht die Spieler
# in der Live-Ausgabe des Panels eine Zeile später. Ein RCON-Anschluss könnte die
