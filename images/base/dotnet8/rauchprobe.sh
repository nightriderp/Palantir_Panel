#!/bin/sh
#
# Rauchprobe für `base/dotnet8`. Läuft nach der Standardprobe, im frisch gebauten
...
#
# **Die Fassung ist hier der Zweck des Images.** `base/dotnet` trägt .NET 10;
# dieses hier gibt es nur, weil tModLoader .NET 8 verlangt. Stünde nach einem
# Bau plötzlich eine 10 in der Liste, wäre das Image sinnlos geworden, ohne
# dass es jemand merkt – die Prüfung unten fängt genau das.
